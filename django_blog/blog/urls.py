...
urlpatterns = [
    ...
    # Comments views
    path('post/<int:post_id>/comment/add/', views.CommentCreateView.as_view(), name='add-comment'),
    path('comment/<int:comment_id>/edit/', views.CommentUpdateView.as_view(), name='edit-comment'),
